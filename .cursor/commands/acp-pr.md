...
Execute ACP Enhanced command `/acp-pr`.

1. Read and follow **every step** in `agent/commands/acp.pr.md`.
...
**Canonical source**: `agent/commands/acp.pr.md`
**Equivalent invocations**: `/acp-pr`, `@acp-pr`, `@agent/commands/acp.pr.md`
